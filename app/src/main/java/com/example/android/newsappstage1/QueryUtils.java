...
public final class QueryUtils {
    ...
    /**
     * Query the guardian API dataset and return a list of {@link OneNews} objects.
     */

    public static List<OneNews> fetchNewsData(String requestUrl) {
        ...
        List<OneNews> news = extractFeatureFromJson(jsonResponse);
    ...
    /**
     * Return a list of {@link OneNews} objects that has been built up from
     * parsing the given JSON response.
     */
    private static List<OneNews> extractFeatureFromJson(String oneNewsJSON) {
